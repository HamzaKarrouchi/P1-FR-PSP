...
| Pandora | Pandore | ✅ *(nom mythologique francisé — cf. « boîte de Pandore » ; cohérent avec Philémon)* |
| Agastya Tree | Arbre Agastya | 🔶 *(nom de l'arbre-sauvegarde)* |
...
| Lunarvale | Lunarvale | 💬 *(US localisé — à trancher : garder ou Mikage ?)* |
...
| Velvet Room | Chambre de Velours | E0_025.json | 🔶 |
...
| Dream World | Monde des Reves | E1_008.json | 🔶 |
